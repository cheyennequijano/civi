...
def main(winstyle=0):
    ...
    img = load_image("kingy.png")
    Player.images = [img, pg.transform.flip(img, 1, 0)]
    img = load_image("kingy.png")
    Explosion.images = [img, pg.transform.flip(img, 1, 1)]
    Alien.images = [load_image(im) for im in ("kingy.png", "kingy.png", "kingy.png")]
    Bomb.images = [load_image("kingy.png")]
    Shot.images = [load_image("kingy.png")]
